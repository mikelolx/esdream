...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`star Bot- Script By : Friendy`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers ' Script By : EsDream  Codes ' `);
    console.log(`----------------`);
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let rank = message.guild.member(message.author).roles.find('name', 'javascript', '• Toxic » Support Plus');
